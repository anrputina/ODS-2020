...
2) Activate miniconda environment. It should automatically activate rebooting the terminal. You can manually activate it with: `'source ~/miniconda3/bin/activate'` (linux). On different OS systems the path might change.
